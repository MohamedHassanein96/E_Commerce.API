...
public class ProductController(IProductService productService) : ControllerBase
{
    ...
    public async Task<IActionResult> GetHighlightedProducts([FromRoute] ProductHighlightType type, CancellationToken cancellationToken)
    {
        var products = await _productService.GetByHighlightTypeAsync(type, cancellationToken);
    ...
    {
        var result = await _productService.ToggleStatus(id, type);
