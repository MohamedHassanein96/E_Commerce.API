namespace E_Commerce.Services
{
    public interface IProductService
    {
        ...
        Task<bool> UpdateAsync(int categoryId,int productId, UpdateProductRequest request, UpdateImagesRequest requestImages, CancellationToken cancellationToken = default);
